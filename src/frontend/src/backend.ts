...
export class Backend implements backendInterface {
    ...
    async addMediaToPost(arg0: PostId, arg1: ExternalBlob, arg2: MediaType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMediaToPost(arg0, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg1), to_candid_MediaType_n9(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createPost(arg0: string, arg1: string, arg2: boolean): Promise<PostId> {
        if (this.processError) {
            try {
    ...
    async getLockedPostContent(arg0: PostId): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getLockedPostContent(arg0);
    ...
    async grantAccess(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.grantAccess(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasAccess(arg0: Principal): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasAccess(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePost(arg0: PostId, arg1: string, arg2: string, arg3: boolean): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_MediaAttachment_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MediaAttachment): Promise<MediaAttachment> {
...
async function from_candid_Post_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Post): Promise<Post> {
...
async function from_candid_opt_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Post]): Promise<Post | null> {
    return value.length === 0 ? null : await from_candid_Post_n14(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        media: await from_candid_vec_n16(_uploadFile, _downloadFile, value.media),
        title: value.title,
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Post>): Promise<Array<Post>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Post_n14(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MediaAttachment>): Promise<Array<MediaAttachment>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MediaAttachment_n17(_uploadFile, _downloadFile, x)));
}
...
function to_candid_MediaType_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MediaType): _MediaType {
...
function to_candid_variant_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MediaType): {
    video: null;
} | {
    image: null;
} {
